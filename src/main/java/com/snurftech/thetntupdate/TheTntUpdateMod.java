package com.snurftech.thetntupdate;
...
import com.snurftech.thetntupdate.init.TheTntUpdateModTabs;
import com.snurftech.thetntupdate.init.TheTntUpdateModItems;
...
@Mod("the_tnt_update")
public class TheTntUpdateMod {
	public static final Logger LOGGER = LogManager.getLogger(TheTntUpdateMod.class);
	public static final String MODID = "the_tnt_update";

	public TheTntUpdateMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		TheTntUpdateModBlocks.REGISTRY.register(modEventBus);
		TheTntUpdateModItems.REGISTRY.register(modEventBus);
		TheTntUpdateModEntities.REGISTRY.register(modEventBus);
		TheTntUpdateModTabs.REGISTRY.register(modEventBus);
