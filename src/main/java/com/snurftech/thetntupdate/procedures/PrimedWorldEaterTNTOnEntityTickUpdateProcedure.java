...
public class PrimedWorldEaterTNTOnEntityTickUpdateProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity.getPersistentData().getDoubleOr("mobEntityTimer", 0) >= 4) {
			...
			world.setBlock(BlockPos.containing(x, y, z), TheTntUpdateModBlocks.WORLD_EATER_BLOCK.get().defaultBlockState(), 3);
