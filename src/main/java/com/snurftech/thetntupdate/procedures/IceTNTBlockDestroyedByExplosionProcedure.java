...
public class IceTNTBlockDestroyedByExplosionProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		if (world instanceof ServerLevel _level) {
			Entity entityToSpawn = TheTntUpdateModEntities.PRIMED_ICE_TNT.get().spawn(_level, BlockPos.containing(x + 0.5, y + 0.5, z + 0.5), EntitySpawnReason.MOB_SUMMONED);
